...
<head>
    ...
    <!-- Title CSS -->
    <title>Credbuddha | Car Loan</title>
        ...
        <div class="container mt-5">
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="container">
                            <h3 class="text-center mb-4"><u>Car Loan </u></h3>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/img/loans/Carloan.webp"
                                    alt="loan-img"></a>

                            <p>OWith CredBuddha, owning your dream car is simpler and more affordable than ever. Our
                                flexible car loans let you choose the car you desire while managing your finances
                                comfortably.
                                <ul>
                                    <li>Flexible Payments: Start with a down payment and repay the balance through convenient
                                    monthly installments.</li>
                                    <li>Competitive Rates: We help you find car loan rates that fit your budget, so you don’t
                                    have to pay the full price upfront.</li>
                                    <li>Accessible Financing: CredBuddha makes car ownership within reach by offering loans
                                    that cater to your financial needs.</li>
                                    <li>Experience the joy of driving your own car without the financial strain. Apply for a car
                                    loan with CredBuddha today and get on the road to owning your perfect vehicle.</li>
                                </ul>
                            </p>

                            <h5>Best Car Loans from Banks</h5>
                            <p>Car loan interest rates can vary based on different factors and different banks. We
                                curated a
                                set of
                                competitive interest rates that are available for you. Go to the bank-wise interest
                                rates
                                now.</p>
                            ...
                            <div class="container-fluid d-md-flex align-items-center justify-content-around p-3 my-5 rounded my-2 text-center"
                                style="border: 1px solid #ddd;">
                                <div class="col-md-1">
                                    <img src="<?php echo base_url(); ?>assets/img/coin.png" alt="Apply for Car Loan"
                                        width="50px">
                                </div>
                                <div class="col-md-8">
                                    <h3 class="d-block p-0 m-0 ">Apply for Car Loan</h3>
                                    <p class="p-0 m-0">Get Car Loan At Your Door Step <span class="text-primary">Apply
                                            now</span>
                                    </p>
                                </div>
                            ...
                            <h5>Features</h5>
                            <ul>
                                <li>New Car: Interest rates 8.90% p.a. onwards</li>
                                <li>Used Car: Interest rates 9.40% p.a. onwards</li>
                                <li>Loan Amount: Up to 100% of the ex-showroom price for new cars, up to 80% of the
                                    car’s
                                    valuation
                                    for used cars</li>
                                <li>Loan Processing Fees: Starting from 0.20% of the loan amount for new cars, up to 2%
                                    of
                                    the loan
                                    amount for used cars</li>
                                <li>Loan Tenure: Up to 7 years for new cars, up to 5 years for used cars</li>
                                <li>Prepayment/Foreclosure Charges: 0.5% - 5% on the outstanding principal or interest
                                    for
                                    the remaining
                                    term of the loan, whichever is lower</li>
                            </ul>

                            <h5>Car Loan EMI Calculator</h5>
                            <ul>
                                <li>Monthly EMI ₹86</li>
                                <li>Principal Amount ₹1,000</li>
                                <li>Total Interest ₹32</li>
                                <li>Total Amount ₹1,032</li>
                            </ul>

                            <h5>Eligibility Criteria</h5>
                            <ul>
                                <li>Type of Car: Used Car loan / New car loan</li>
                                <li>Residence: Urban / Rural / Semi-rural</li>
                                <li>Age: 18 yrs - 75 yrs</li>
                                <li>Employment type: Salaried / Self</li>
                            </ul>

                            <h5>Documents Required to Apply for Car Loan</h5>
                            <ul>
                            ...
                            <h5>Car Loan Foreclosure</h5>
                            <p>Car loan foreclosure lets you repay the remaining loan amount early, helping you save on
                                interest costs and clear your debt sooner. However, it’s important to note the
                                following:</p>
                            <ul>
                                <li>Foreclosure Fees: Lenders may charge a fee for early repayment. This fee is usually
                                    a percentage of the outstanding loan amount.</li>
                                <li>Lock-in Period: Some loans have a minimum period before you can foreclose. You may
                                    be required to wait until this period ends.</li>
                                <li>Requirements and Documentation: Each lender has specific requirements and
                                    documentation for the foreclosure process. It's best to contact your lender directly
                                    to understand the exact steps and any associated conditions.</li>
                            </ul>
                            <p>Foreclosing your car loan can be a smart financial move, but make sure to review the
                                terms and conditions with your lender to avoid any surprises.</p>


                            <h5 class="mb-4">Frequently Asked Questions</h5>
                            <ul>
                                    <h6>1. What is a car loan?</h6>
                                    <p>A car loan is a type of financing that allows you to purchase a vehicle by
                                        borrowing money from a bank or financial institution. You repay the loan amount,
                                        plus interest, over a specified period through monthly installments.</p>
                                </li>
                                <li>
                                    <h6>2. How can I apply for a car loan with CredBuddha?</h6>
                                    <p>Applying for a car loan is easy with CredBuddha. Simply fill out our online
                                        application form with your details, and connect with the best loan offers from
                                        top lenders.</p>
                                </li>
                                <li>
                                    <h6>3. What are the eligibility criteria for a car loan?</h6>
                                    <p>Eligibility typically depends on your age, income, employment status, credit
                                        score, and the type of vehicle you wish to purchase. Each lender may have
                                        slightly different criteria.</p>
                                </li>
                                <li>
                                    <h6>4. How much can I borrow with a car loan?</h6>
                                    <p>The loan amount you can borrow usually depends on your income, creditworthiness,
                                        and the value of the car. Lenders often finance up to 80%-100% of the car’s
                                        on-road price.</p>
                                </li>
                                <li>
                                    <h6>5. What documents are required to apply for a car loan?</h6>
                                    <p>Commonly required documents include proof of identity (Aadhar Card, PAN Card),
                                        proof of address, income proof (salary slips, bank statements, or tax returns),
                                        and vehicle-related documents. Some lenders may ask for additional
                                        documentation.</p>
                                </li>
                                <li>
                                    <h6>6. What is the interest rate for a car loan?</h6>
                                    <p>Interest rates vary by lender and can be fixed or floating. Car loan interest
                                        rates typically start around 7.50% to 14% p.a. It’s beneficial to compare rates
                                        from different lenders to find the best deal.</p>
                                </li>
                                <li>
                                    <h6>7. What is the tenure for a car loan?</h6>
                                    <p>Car loan tenures generally range from 1 to 7 years. Choosing a longer tenure can
                                        lower your monthly EMI but may increase the total interest paid over the loan
                                        period.</p>
                                </li>
                                <li>
                                    <h6>8. What is a down payment?</h6>
                                    <p>A down payment is an initial upfront amount that you pay when purchasing a car.
                                        It reduces the loan amount you need to borrow. The higher the down payment, the
                                        lower your loan amount and monthly EMIs.</p>
                                </li>
                                <li>
                                    <h6>9. What is an EMI and how is it calculated?</h6>
                                    <p>EMI (Equated Monthly Installment) is the fixed monthly payment you make towards
                                        repaying your loan. It includes both principal and interest. You can use an EMI
                                        calculator to estimate your monthly payments based on the loan amount, interest
                                        rate, and tenure.</p>
                                </li>
                                <li>
                                    <h6>10. Can I get a car loan with a low credit score?</h6>
                                    <p>Yes, but it may be more challenging. Some lenders offer car loans to individuals
                                        with lower credit scores, often at higher interest rates. Improving your credit
                                        score can help you secure better terms.</p>
                                </li>
                                <li>
                                    <h6>11. What happens if I miss an EMI payment?</h6>
                                    <p>Missing an EMI payment can result in late fees and negatively affect your credit
                                        score. It’s important to inform your lender immediately and explore possible
                                        solutions if you’re unable to make a payment.</p>
                                </li>
                                <li>
                                    <h6>12. Can I get a loan for a used car?</h6>
                                    <p>Yes, many lenders offer loans for used or pre-owned cars. The loan amount and
                                        interest rates for used cars may differ from those for new cars.</p>
                                </li>
                                <li>
                                    <h6>13. Are there any tax benefits for car loans?</h6>
                                    <p>Generally, car loans do not offer tax benefits for personal vehicles. However, if
                                        the car is used for business purposes, you may be able to claim certain
                                        deductions. It’s best to consult with a tax advisor for specific advice.</p>
                                </li>
                            </ul>
