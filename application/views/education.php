...
<head>
    ...
    <!-- Title CSS -->
    <title>Credbuddha | Education Loan</title>
        ...
        <div class="container mt-5">
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="container">
                            <h3 class="text-center mb-4"><u> Education Loan </u></h3>
                            <a href="#"><img src="<?php echo base_url(); ?>assets/img/loans/Educationloan.webp" alt="loan-img"></a>
                            <p>Turn your academic aspirations into reality with CredBuddha's education loan aggregator
                                platform. We offer competitive interest rates and flexible terms, making higher
                                education
                                accessible and affordable. Apply seamlessly for student loans from over 30 top banks and
                                NBFCs. Discover the best education loan schemes tailored to your needs.</p>

                            <h5>Top Banks and NBFCs Offering Education Loans Through CredBuddha:</h5>
                            <ul>
                                <li>Aditya Birla Education Loan: Starting from 10.99% p.a.</li>
                                <li>Tata Capital: Starting from 10.99% p.a.</li>
                                <li>Money View: From 1.33% per month onwards</li>
                                <li>IIFL: Starting from 13.50% p.a.</li>
                                <li>Bajaj Finserv Education Loan: From 10.10% p.a. onwards</li>
                            </ul>
                            ...
                            <div class="container d-md-flex align-items-center justify-content-around p-3 my-5 rounded my-2 text-center"
                                ...
                                <div class="col-md-8">
                                    <h3 class="d-block p-0 m-0 ">Apply for Educational Loan</h3>
                            ...
                            <h5>Education Loan Features and Benefits:</h5>
                            <ul>
                                <li><strong>Interest Rates:</strong> Compare and find the lowest rates suitable for you.
                                </li>
                                <li><strong>EMI Calculators:</strong> Easily estimate your monthly installments.</li>
                                <li><strong>Eligibility Criteria:</strong> Check eligibility based on age, academic
                                    record,
                                    and more.</li>
                                <li><strong>Documents Required:</strong> Streamlined documentation process for quick
                                    approval.</li>
                                <li><strong>No Collateral Needed:</strong> Access funds without security or guarantors.
                                </li>
                                <li><strong>Tax Benefits:</strong> Enjoy deductions under Section 80E of the Income Tax
                                    Act.
                                </li>
                                <li><strong>Flexible Repayment Options:</strong> Tailored plans to fit your financial
                                    capability.</li>
                                <li><strong>Simple Application Process:</strong> Hassle-free online application with
                                    quick
                                    processing.</li>
                            </ul>

                            <h5>Education Loan Types Available:</h5>
                            <ul>
                                <li><strong>Domestic Education Loans:</strong> For courses within India.</li>
                                <li><strong>Study Abroad Education Loans:</strong> Covering international education
                                    expenses.</li>
                            </ul>

                            <h5>List of Covered Expenses:</h5>
                            <ul>
                                <li>Tuition fees, accommodation, study materials, exam fees, and more.</li>
                            </ul>

                            <h5>Education Loan Repayment Options:</h5>
                            <p>Monthly installments, pre-payment, and part-payment facilities available.</p>
                            ...
                            <ul>
                                <li>Age: 18 years to 35 years</li>
                                <li>Nationality: Indian</li>
                                <li>Academic record: Proven to be good</li>
                                <li>Income source: Parents/Guardians with stable income</li>
                                <li>University: Recognized in India or Abroad</li>
                                <li>Admission Status: Confirmed admission in the University</li>
                                <li>Security: Based on the loan amount and income source, tangible collateral or
                                    guarantor
                                    may be required</li>
                            </ul>
                            ...
                            <ul>
                                <li>Filled & signed application form with affixed photographs</li>
                                <li>Mark sheets of 10th/12th or latest education certificate</li>
                                <li>Statement of the cost of the course</li>
                                <li>Age proof: Aadhaar Card, Voter ID, Passport, Driving Licence</li>
                                <li>Identity proof: Voter ID, Aadhaar Card, Driving Licence, Passport</li>
                                <li>Residence proof: Rental agreement, Bank statement of 6 months of the student or
                                    co-borrower/guarantor, Gas Book / Electricity Bill / Tel Bill</li>
                                <li>Income proof: Salary slips/Form 16 of the parent/guardian/co-borrower, Bank
                                    statement
                                    (last 6 months) of the borrower, ITR of two years of parent/co-borrower/guardian
                                </li>
                            </ul>
