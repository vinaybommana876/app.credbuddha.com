                    ...
                    <?php if(!empty($blogs)): ?>
                        <?php foreach ($blogs as $blog): ?>
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('uploads/' . $blog['blog_img']); ?>" alt="Blog Image" style="max-width: 50px;"></td>
                                <td><a class="btn btn-info" href="<?php echo base_url('admin/blog/editblog/'.$blog['blog_id']); ?>">Edit</a></td>
                                <td><a class="btn btn-danger" href="<?php echo base_url('admin/blog/deleteblog/'.$blog['blog_id']); ?>">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
