! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).noUiSlider = {}) }(this, function(st) {
    "use strict";
    var t, e;
    ...
    var s = function() {
            function t(e, t, r) {
                ...
                var i = [];
                for (Object.keys(e).forEach(function(t) { i.push([ft(e[t]), t]) }), i.sort(function(t, e) { return t[0][0] - e[0][0] }), n = 0; n < i.length; n++) this.handleEntryPoint(i[n][1], i[n][0]);
            ...
            return t.prototype.getDistance = function(t) {
                ...
                return t + u
            }, t.prototype.toStepping = function(t) { return t = n(this.xVal, this.xPct, t) }, t.prototype.fromStepping = function(t) {
        ...
        a = { to: function(t) { return void 0 === t ? "" : t.toFixed(2) }, from: Number },
        l = { target: "target", base: "base", origin: "origin", handle: "handle", handleLower: "handle-lower", handleUpper: "handle-upper", touchArea: "touch-area", horizontal: "horizontal", vertical: "vertical", background: "background", connect: "connect", connects: "connects", ltr: "ltr", rtl: "rtl", textDirectionLtr: "txt-dir-ltr", textDirectionRtl: "txt-dir-rtl", draggable: "draggable", drag: "state-drag", tap: "state-tap", active: "active", tooltip: "tooltip", pips: "pips", pipsHorizontal: "pips-horizontal", pipsVertical: "pips-vertical", marker: "marker", markerHorizontal: "marker-horizontal", markerVertical: "marker-vertical", markerNormal: "marker-normal", markerLarge: "marker-large", markerSub: "marker-sub", value: "value", valueHorizontal: "value-horizontal", valueVertical: "value-vertical", valueNormal: "value-normal", valueLarge: "value-large", valueSub: "value-sub" },
        gt = { tooltips: ".__tooltips", aria: ".__aria" };

    function u(t) { if ("object" == typeof(e = t) && "function" == typeof e.to && "function" == typeof e.from) return !0; var e; throw new Error("noUiSlider: 'format' requires 'to' and 'from' methods.") }
    ...
    function U(t, e) { u(e), t.ariaFormat = e }

    function M(t, e) { u(e), t.format = e }
    ...
    function vt(e) {
        var r = { margin: null, limit: null, padding: null, animate: !0, animationDuration: 300, ariaFormat: a, format: a },
            ...
            i = { connect: !1, direction: "ltr", behaviour: "tap", orientation: "horizontal", keyboardSupport: !0, cssPrefix: "noUi-", cssClasses: l, keyboardPageMultiplier: 5, keyboardDefaultStep: 10 };
    ...
    function O(t, b, o) {
        var l, u, s, i, a, e, c, p = window.navigator.pointerEnabled ? { start: "pointerdown", move: "pointermove", end: "pointerup" } : window.navigator.msPointerEnabled ? { start: "MSPointerDown", move: "MSPointerMove", end: "MSPointerUp" } : { start: "mousedown touchstart", move: "mousemove touchmove", end: "mouseup touchend" },
        ...
        function L(m) {
            var g = function(t) { if (t.mode === st.PipsMode.Range || t.mode === st.PipsMode.Steps) return y.xVal; if (t.mode !== st.PipsMode.Count) return t.mode === st.PipsMode.Positions ? D(t.values, t.stepped) : t.mode === st.PipsMode.Values ? t.stepped ? t.values.map(function(t) { return y.fromStepping(y.getStep(y.toStepping(t))) }) : t.values : []; if (t.values < 2) throw new Error("noUiSlider: 'values' (>= 2) required for mode 'count'."); for (var e = t.values - 1, r = 100 / e, n = []; e--;) n[e] = e * r; return n.push(100), D(n, t.stepped) }(m),
                v = {},
                t = y.xVal[0],
                ...
                S = !1,
                x = 0;
            return (g = g.slice().sort(function(t, e) { return t - e }).filter(function(t) { return !this[t] && (this[t] = !0) }, {}))[0] !== t && (g.unshift(t), b = !0), g[g.length - 1] !== e && (g.push(e), S = !0), g.forEach(function(t, e) {
        ...
        function j(t) {
            ...
            var e = L(t),
                r = t.filter,
                n = t.format || { to: function(t) { return String(Math.round(t)) }, from: Number };
        ...
        function H(i, o, s, a) {
            var e = function(t) {
                    var e, r, n = function(r, t, n) {
                        ...
                        if (e) {
                            var l = function(t) { var e = t.target; return e === n || n.contains(e) || r.composed && r.composedPath().shift() === n };
                ...
                r = [];
            return i.split(" ").forEach(function(t) { o.addEventListener(t, e, !!f && { passive: !0 }), r.push([t, e]) }), r
        }
        ...
        function n(t) {
            ...
            !1 !== r && (b.events.snap || ct(d, b.cssClasses.tap, b.animationDuration), Z(r, e, !0, !0), Q(), W("slide", r, !0), W("update", r, !0), W("change", r, !0), W("set", r, !0), b.events.snap && q(t, { handleNumbers: [r] }))
        }
        ...
        function J(t, n, r, e, i) {
            var o = r.slice(),
                ...
                a = [!t, t],
                l = [t, !t];
            e = e.slice(), t && e.reverse(), 1 < e.length ? e.forEach(function(t, e) { var r = $(o, t, o[t] + n, a[e], l[e], !1);!1 === r ? n = 0 : (n = r - o[t], o[t] = r) }) : a = l = [!0];
            var u = !1;
        ...
        function rt(t, e, r) {
            var n = ft(t),
                i = void 0 === x[0];
            e = void 0 === e || e, b.animate && !i && ct(d, b.cssClasses.tap, b.animationDuration), h.forEach(function(t) { Z(t, et(n[t], t), !0, !1, r) });
            for (var o = 1 === h.length ? 0 : 1; o < h.length; ++o) h.forEach(function(t) { Z(t, x[t], !0, !0, r) });
        ...
        dt(e = d, b.cssClasses.target), 0 === b.dir ? dt(e, b.cssClasses.ltr) : dt(e, b.cssClasses.rtl), 0 === b.ort ? dt(e, b.cssClasses.horizontal) : dt(e, b.cssClasses.vertical), dt(e, "rtl" === getComputedStyle(e).direction ? b.cssClasses.textDirectionRtl : b.cssClasses.textDirectionLtr), l = C(e, b.cssClasses.base),
            ...
            }(b.connect, l), (c = b.events).fixed || u.forEach(function(t, e) { H(p.start, t.children[0], q, { handleNumbers: [e] }) }), c.tap && H(p.start, l, n, {}), c.hover && H(p.move, l, X, { hover: !0 }), c.drag && s.forEach(function(e, r) {
                if (!1 !== e && 0 !== r && r !== s.length - 1) {
                    var n = u[r - 1],
                        i = u[r],
                        t = [e];
                    dt(e, b.cssClasses.draggable), c.fixed && (t.push(n.children[0]), t.push(i.children[0])), t.forEach(function(t) { H(p.start, t, q, { handles: [n, i], handleNumbers: [r - 1, r], connect: e }) })
                }
        ...
        var ot = {
            destroy: function() {
                for (I(gt.aria), I(gt.tooltips), Object.keys(b.cssClasses).forEach(function(t) { ht(d, b.cssClasses[t]) }); d.firstChild;) d.removeChild(d.firstChild);
                delete d.noUiSlider
            },
            steps: function() { return h.map(it) },
            on: Y,
            off: I,
            get: nt,
            set: rt,
            ...
            reset: function(t) { rt(b.start, t) },
            __moveHandles: function(t, e, r) { J(t, e, x, r) },
            options: o,
            updateOptions: function(e, t) {
                ...
                var i = vt(o);
                n.forEach(function(t) { void 0 !== e[t] && (b[t] = i[t]) }), y = i.spectrum, b.margin = i.margin, b.limit = i.limit, b.padding = i.padding, b.pips ? j(b.pips) : O(), b.tooltips ? A() : M(), x = [], rt(lt(e.start) ? e.start : r, t)
            },
            target: d,
            removePips: O,
            removeTooltips: M,
            getTooltips: function() { return a },
    ...
    function j(t, e) { if (!t || !t.nodeName) throw new Error("noUiSlider: create requires a single element, got: " + t); if (t.noUiSlider) throw new Error("noUiSlider: Slider was already initialized."); var r = O(t, vt(e), e); return t.noUiSlider = r }
    var z = { __spectrum: s, cssClasses: l, create: j };
    st.create = j, st.cssClasses = l, st.default = z, Object.defineProperty(st, "__esModule", { value: !0 })
});