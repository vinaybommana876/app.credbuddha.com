...
<head>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=650677626548030&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>
                ...
                <section>
                    <div class="row g-0">
                        <div class="col-12 d-flex justify-content-center pt-3 pb-1">
                            <img src="<?php echo $offer->offer_icon; ?>" width="100px" class="img-fluid" alt="Logo">
                        </div>
                    </div>
                </section>
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                <div class="d-flex justify-content-center py-3">
                                    <img src="<?php echo base_url(); ?>assets/offerTwo/img/success.svg" width="60px"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="d-flex justify-content-center text-center">
                                    <h1 class="text-dark ">
                                        <div class="font-weight-normal mb-3"> Congratulations! <br><span
                                                class="text-info">You have Pre-approved offer from fibe upto Rs.
                                                5,00,000/-</span></div>
                                ...
                                <div class=" flex-column text-center px-3">
                                    <h4 class="text-dark py-0 my-0"> <?php echo $offer->offer_name; ?></h4>
                                    <p class="py-0 mt-0 mb-3"><strong> <small> Tenure upto: 24 Months. <br>
                                                <p class="py-0 mt-0 mb-3"><strong> <small> Instant Disbursement in 5
                                                            mins <br>
                                                            Low interest<br>
                                                            Hassle-free process
                                                        </small> </strong></p>
                                ...
                                <div class="form-floating custom-radius-last hero__info__button">
                                    <a href="<?php echo $offer->offer_url . "" . $lead->utm_source; ?>"><button
                                            class="btn btn-success w-100 py-3">Download & Apply <img width="15px"
                                                src="<?php echo base_url(); ?>assets/offerTwo/img/right.svg"
